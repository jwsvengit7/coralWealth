...
<nav class="navbar top-navbar navbar-expand-md">
    <div class="navbar-header" data-logobg="skin6">
        ...
        <div class="navbar-brand">
            <a href="https://corawealth.com">

                <span class="logo-text">
                    <img src="https://corawealth.com/assets/uploads/logo/admin-logo.png" alt="homepage"
                         class="dark-logo"/>
                    <img src="https://corawealth.com/assets/uploads/logo/admin-logo.png" class="light-logo"
                         alt="homepage"/>
                </span>
            </a>
        </div>
            ...
            <li class="nav-item dropdown">
                ...
                <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                   aria-haspopup="true" aria-expanded="false">
                    <img src="https://corawealth.com/assets/uploads/admin/656f7c1d981861701805085.jpeg"
                         alt="user"
                         class="rounded-circle width-40p">
                    <span class="ml-2 d-none d-lg-inline-block"><span class="text-dark">Hello,</span> <span
                            class="text-dark">corawealth</span> <i
                ...
                <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                    ...
                    <a class="dropdown-item" href="https://corawealth.com/admin/profile">
                        <i class="svg-icon mr-2 ml-1 icon-user color-primary"></i>
                        Profile                        </a>

                    <a class="dropdown-item" href="https://corawealth.com/admin/password">
                        <i class="svg-icon mr-2 ml-1 icon-settings color-secondary"></i>
                        Password                        </a>

                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="https://corawealth.com/admin/logout"
                       onclick="event.preventDefault();
                                                 document.getElementById('logout-form').submit();"><i
                            data-feather="power" class="svg-icon mr-2 ml-1 text-purple"></i>
                        Logout
                    </a>
                    <form id="logout-form" action="https://corawealth.com/admin/logout" method="POST" class="d-none">
                        <input type="hidden" name="_token" value="5GEtz3hMy1JOaGkcKHNIkLyc99uQqm2IJ2PYTnzv">                        </form>
