...
<div class="container">
  <div class="form-div">
    <form class="login-form" method="post" id="register">
        <h3>Signup Here</h3>
        <div style="border-bottom: 4px solid #ff8647;width: 150px;margin-bottom: 20px;"></div>
        <p>Get started Now! Open an account with Us. CoralWealth</p>
        ...
        <p></p>
        <label>
            Already have an account&nbsp; <a href="login.php" style="color:#ff8647">Login</a>
        </label>
...
$(()=>{
  $("#register").on("submit",function(e){
    ...
    $.ajax({
    url:"http://localhost/coralwealth/topadmin/src/api/register.php",
    cache:false,
    type: "POST",
